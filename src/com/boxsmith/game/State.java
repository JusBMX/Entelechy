 ...
 */
public enum State {
    MAIN (new Main(), new MainMenuLevel("/Levels/Main Menu/MainMenuTiles.png")), // The main menu
    LOAD (new Load(), new MainMenuLevel("/Levels/Main Menu/MainMenuTiles.png")), // The save select
    PLAY (Play.play, new TestLevel("/Levels/Test/TestLevelTiles.png")); // The main play.
